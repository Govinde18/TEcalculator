...
def main():
    ...
    recovery_volume_ul = st.number_input('Final volume after recovery (in µL):', min_value=0.0, value=1000.0, step=1.0)
    dna_ug = st.number_input('Amount of DNA added (in µg):', min_value=0.0, value=0.1, step=0.1)
    volume_plated_ul = st.number_input('Volume plated (in µL):', min_value=0.0, value=100.0, step=1.0)
